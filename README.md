...
1. The robot detects the predefined line using line sensors.
2. Sensor readings are processed by the microcontroller.
3. The motor driver controls the DC motors based on the sensor values.
4. When an obstacle is detected, the robot changes its movement direction to avoid it.
5. After avoiding the obstacle, the robot continues following the line path.
